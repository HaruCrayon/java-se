...
public class Homework01 {
    ...
    public void test() {
        ...
        dao.save("001", new User(1, 28, "jack"));
        dao.save("002", new User(2, 17, "tom"));
        dao.save("003", new User(3, 45, "smith"));

        List<User> list = dao.list();
        System.out.println("list=" + list);

        dao.update("001", new User(1, 36, "harry"));
        dao.delete("002");
...
/**
 * 定义泛型类 DAO<T>，在其中定义一个Map 成员变量，Map 的键为 String 类型，值为 T 类型。
 * <p>
 * 分别创建以下方法：
